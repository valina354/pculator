...
void OPL3_init(opl3_chip* chip) {
    debug_log(DEBUG_DETAIL, "[OPL] Initializing OPL\r\n");
    OPL3_Reset(chip, SAMPLE_RATE);
    ports_cbRegister(0x388, 2, (void*)OPL3_read, NULL, (void*)OPL3_write, NULL, chip);
    ports_cbRegister(0x228, 2, (void*)OPL3_read, NULL, (void*)OPL3_write, NULL, chip); //TODO: this should actually be whatever SB base port + 8, so if it's not at 0x220, this is wrong.
}
